...
\begin{enumerate}[label=(\alph{*})]
	\item 
		\begin{description}
			\item[Solução por Allan Kenedy:] Tese: $\forall n((n\in\omega)\wedge(n\neq n^+))$.
			...
			\item[Solução por Cloves Paiva:] Usemos $\omega$ da definição 3.19 como modelo para $\mathbb{N}$. Pelo Teorema 3.20, $\omega$ satisfaz os Axiomas de Peano e, portanto, podemos aplicar o Princípio da Indução Finita. Por indução, verifiquemos que:
				\begin{enumerate}
